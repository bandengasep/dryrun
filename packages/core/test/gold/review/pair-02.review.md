# Pair 02 — adjudication review sheet (28 gaps, 0 adjudicated)
...
**Engine's rationale:** No resume line mentions maintaining pipelines, shipment data, or services related to reliability/performance.
...
**Engine's rationale:** cv-18 shows basic SQL queries against an agency reporting database but does not indicate operating or scaling batch pipelines feeding a data warehouse.
...
**Engine's rationale:** No resume line references AWS provisioning, deployment, or automation.
...
**Engine's rationale:** No resume line describes work on observability, monitoring, or alerting for data services.
...
**Engine's rationale:** No resume line mentions improving or implementing alerting for data services.
...
**Engine's rationale:** No resume line references incident response or related practices for data services.
...
**Engine's rationale:** No resume line describes building internal tooling or self-serve platform resources for product teams.
...
**Engine's rationale:** No resume line indicates multi-year experience operating production AWS infrastructure.
...
**Engine's rationale:** No resume line mentions EC2 or equivalent experience.
...
**Engine's rationale:** No resume line mentions S3 or related experience.
...
**Engine's rationale:** No resume line references IAM or identity/access management experience.
...
**Engine's rationale:** No resume line mentions VPC or networking experience in cloud environments.
...
**Engine's rationale:** No resume line indicates deploying or running services on Kubernetes.
...
**Engine's rationale:** No resume line references Terraform or infrastructure-as-code work.
...
**Engine's rationale:** No resume line describes reviewing or applying Terraform through CI.
...
**Engine's rationale:** No resume line mentions building or operating Airflow DAGs or scheduled data pipelines.
...
**Engine's rationale:** No resume line demonstrates proficiency writing production services in Go.
...
**Engine's rationale:** No resume line demonstrates proficiency writing production services in Python.
...
**Engine's rationale:** cv-56 lists SQL (basic SELECT queries), indicating some SQL skill but not strong SQL or data-warehouse-level expertise or tuning.
...
**Engine's rationale:** No resume line references day-to-day operations of Redshift or Snowflake/data warehouse management.
...
**Engine's rationale:** cv-22 notes basic SQL queries which touches querying but does not demonstrate query tuning for data warehouses.
...
**Engine's rationale:** No resume line mentions experience with Amazon Redshift.
...
**Engine's rationale:** No resume line mentions experience with Snowflake.
...
**Engine's rationale:** No resume line indicates participation in an on-call rotation for platform incidents.
...
**Engine's rationale:** cv-30 shows presenting quarterly results to stakeholders, evidencing communication skills but not runbooks, postmortems, or incident-update writing specifically.
...
**Engine's rationale:** No resume line indicates writing runbooks or operational documentation.
...
**Engine's rationale:** No resume line indicates writing postmortems.
...
**Engine's rationale:** No resume line indicates writing incident updates.
